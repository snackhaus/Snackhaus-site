      ...
      <section className="pt-20 md:pt-32 relative h-screen overflow-hidden">
        ...
        <div className="relative h-full container-custom flex items-center md:items-center">
          <div className="w-full flex">
            ...
            <div className="w-2/3 md:w-2/3"></div>
            <div className="w-1/3 md:w-1/3 text-white pr-2 pl-2 md:pr-0 md:pl-0 -mt-16 md:mt-0">
              <motion.h1 
                className="text-xl md:text-5xl lg:text-6xl font-bold mb-2 md:mb-4 leading-tight"
              ...
              <motion.p 
                className="text-xs md:text-xl mb-3 md:mb-8 text-white/90 leading-snug"
                initial={{ opacity: 0, y: -20 }}
                animate={{ opacity: 1, y: 0 }}
              ...
              >
                <a href="#get-started" className="bg-primary text-secondary-dark px-3 py-2 md:px-6 md:py-3 rounded-lg font-semibold hover:bg-primary-dark transition-all text-center text-xs md:text-base shadow-lg">
                  Get a Cooler
                </a>
                <a href="#how-it-works" className="bg-white/20 backdrop-blur-sm hover:bg-white/30 text-white transition-colors px-3 py-2 md:px-6 md:py-3 rounded-lg flex items-center justify-center text-xs md:text-base border border-white/30">
                  How It Works
                </a>
              </motion.div>
            </div>
