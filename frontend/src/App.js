      ...
      <section className="pt-20 md:pt-32 relative h-screen overflow-hidden">
        ...
        <div className="absolute inset-0">
          <img 
            ...
            className="w-full h-full object-cover object-[15%_10%] md:object-[70%_10%] brightness-125 contrast-110 transform translate-y-16"
          />
        ...
        <div className="relative h-full container-custom flex items-center">
          <div className="w-full">
            {/* Mobile: Content positioned far right to avoid cooler text, Desktop: Content on right */}
            <div className="text-white px-2 md:px-0 ml-auto max-w-40 md:max-w-lg mr-1 md:mr-0">
              <motion.h1 
                className="text-lg md:text-5xl lg:text-6xl font-bold mb-1 md:mb-4 leading-tight"
              ...
              >
                <a href="#get-started" className="bg-primary text-secondary-dark px-3 py-1 md:px-6 md:py-3 rounded-md font-semibold hover:bg-primary-dark transition-all text-center text-xs md:text-base">
                  Get a Cooler
                </a>
                <a href="#how-it-works" className="bg-white/20 backdrop-blur-sm hover:bg-white/30 text-white transition-colors px-3 py-1 md:px-6 md:py-3 rounded-md flex items-center justify-center text-xs md:text-base">
                  How It Works
                </a>
              </motion.div>
            </div>
